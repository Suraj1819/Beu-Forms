// app/api/job-notifications/[id]/approve/route.ts
...
export async function PATCH(
  ...
  try {
    ...
    const approvedNotification = await notification.approve(reviewerName, reviewNotes || '');

    return sendResponse(200, 'Job notification approved successfully', approvedNotification);
  } catch (error: any) {
